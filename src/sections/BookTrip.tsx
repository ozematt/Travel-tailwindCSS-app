  ...
  return (
    <section className="px-[34px] sm:px-[120px] mt-[100px] sm:mt-[200px] w-full relative">
      <div className="max-w-[512px]">
        ...
        <h2 className="font-volkhov capitalize font-bold text-5xl leading-[60px] mt-4">
        ...
        {steps.map((step, index) => (
          <div key={index} className="flex items-center mt-7">
            ...
            <div className="ml-6">
              <p className="font-poppins font-bold text-text-color">
                {step.title}
              </p>
              <p className="max-w-[327px] font-poppins text-text-color">
                {step.text}
              </p>
            </div>
          </div>
